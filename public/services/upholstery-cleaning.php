...
renderHeader(["title" => "Upholstery Cleaning"]);

?>

<section class="service-selector before-after">
    <div class="overlay"></div>
    <div class="background-img-1" style="background-image: url('/images/upholstery-cleaning/upholstery-cleaning-1.jpg')"></div>
        ...
        <div class="service-selector-slide">
            ...
            <div class="items">
                <div class="item-container middle" data-id="0"
                    ...
                    <div class="item-content before" style="background-image: url('/images/upholstery-cleaning/upholstery-cleaning-1.jpg')"></div>
                    <div class="item-content after" style="background-image: url('/images/upholstery-cleaning/upholstery-cleaning-2.jpg')"></div>
                </div>
                <div class="item-container invisible" data-id="1"
                        data-background-image="/images/upholstery-cleaning/upholstery-cleaning-3.jpg"
                        data-overlay-opacity="0.7">
                    <div class="item-content before" style="background-image: url('/images/upholstery-cleaning/upholstery-cleaning-3.jpg')"></div>
                    <div class="item-content after" style="background-image: url('/images/upholstery-cleaning/upholstery-cleaning-1.jpg')"></div>
                </div>
            </div>
...
<section class="about service">
    <div class="container">
        ...
        <div class="image">
            <img src="/images/upholstery-cleaning/upholstery-cleaning-1.jpg" />
        </div>
    </div>
</section>
<section class="about service">
    <div class="container">
        ...
        <div class="image">
            <img src="/images/upholstery-cleaning/upholstery-cleaning-2.jpg" />
        </div>
    </div>
</section>
<section class="about service">
    <div class="container">
        ...
        <div class="image">
            <img src="/images/upholstery-cleaning/upholstery-cleaning-3.jpg" />
        </div>
    </div>
</section>
<section class="reviews">
    <div class="container">
        ...
        renderReview([
            "name" => "Gary D.",
            "location" => "Dacula, GA",
            "review" => "We were thinking about purchasing new living room sofas, but Ken said he could clean them. Now they look brand new! Prompt, professional, and friendly. I would definitely recommend them!",
            "rating" => 5
        ]);
        ...
        renderReview([
            ...
            "review" => "They have been cleaning our upholstery and carpet since 1978 and they continue to do a fantastic job.",
            "rating" => 5
        ]);
