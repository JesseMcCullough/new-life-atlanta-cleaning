...
renderHeader(["title" => "Carpet Cleaning"]);

?>

<section class="service-selector before-after">
    <div class="overlay"></div>
    <div class="background-img-1" style="background-image: url('/images/carpet-cleaning/carpet-cleaning-2-after.jpg')"></div>
        ...
        <div class="service-selector-slide">
            ...
            <div class="items">
                <div class="item-container middle" data-id="0"
                        data-background-image="/images/carpet-cleaning/carpet-cleaning-2-after.jpg"
                        data-overlay-opacity="0.5">
                    <div class="item-content before" style="background-image: url('/images/carpet-cleaning/carpet-cleaning-2-before.jpg')"></div>
                    <div class="item-content after" style="background-image: url('/images/carpet-cleaning/carpet-cleaning-2-after.jpg')"></div>
                </div>
                <div class="item-container invisible" data-id="1"
                        data-background-image="/images/carpet-cleaning/carpet-cleaning-3-after.jpg"
                        data-overlay-opacity="0.5">
                    <div class="item-content before" style="background-image: url('/images/carpet-cleaning/carpet-cleaning-3-before.jpg')"></div>
                    <div class="item-content after" style="background-image: url('/images/carpet-cleaning/carpet-cleaning-3-after.jpg')"></div>
                </div>
                <div class="item-container invisible" data-id="2"
                        data-background-image="/images/carpet-cleaning/carpet-cleaning-4-after.jpg"
                        data-overlay-opacity="0.5">
                    <div class="item-content before" style="background-image: url('/images/carpet-cleaning/carpet-cleaning-4-before.jpg')"></div>
                    <div class="item-content after" style="background-image: url('/images/carpet-cleaning/carpet-cleaning-4-after.jpg')"></div>
                </div>
                <div class="item-container invisible" data-id="3"
                        data-background-image="/images/carpet-cleaning/carpet-cleaning-1-after.jpg"
                        data-overlay-opacity="0.7">
                    <div class="item-content before" style="background-image: url('/images/carpet-cleaning/carpet-cleaning-1-before.jpg')"></div>
                    <div class="item-content after" style="background-image: url('/images/carpet-cleaning/carpet-cleaning-1-after.jpg')"></div>
                </div>
            </div>
...
<section class="about service">
    <div class="container">
        ...
        <div class="image">
            <img src="/images/carpet-cleaning/carpet-cleaning-5.jpg" />
        </div>
    </div>
</section>
<section class="about service">
    <div class="container">
        ...
        <div class="image">
            <img src="/images/carpet-cleaning/carpet-cleaning-6.jpg" />
        </div>
    </div>
</section>
<section class="about service">
    <div class="container">
        ...
        <div class="image">
            <img src="/images/carpet-cleaning/carpet-cleaning-8.jpg" />
        </div>
    </div>
</section>
<section class="about service">
    <div class="container">
        ...
        <div class="image">
            <img src="/images/carpet-cleaning/carpet-cleaning-7.jpg" />
        </div>
    </div>
</section>
<section class="about service">
    <div class="container">
        ...
        <div class="image">
            <img src="/images/carpet-cleaning/carpet-cleaning-9.jpg" />
        </div>
    </div>
</section>
<section class="about service">
    <div class="container">
        ...
        <div class="image">
            <img src="/images/carpet-cleaning/carpet-cleaning-10.jpg" />
        </div>
    </div>
</section>
